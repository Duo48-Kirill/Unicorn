...
def g8():
    ...
    next_object = pygame.font.SysFont("arial", 18)
    ...
    end.image = pygame.image.load("static/8/png/ground/end.png")
    end.rect = end.image.get_rect()
    end.rect.left = 0
    end.rect.top = 0

    start = pygame.sprite.Sprite(initial)
    start.image = pygame.image.load("static/8/png/ground/start.png")
    start.rect = start.image.get_rect()
    start.rect.left = 0
    start.rect.top = 0

    background_1 = pygame.image.load("static/8/png/ground/background 1.png")
    background_2 = pygame.image.load("static/8/png/ground/background 2.png")
    background_3 = pygame.image.load("static/8/png/ground/background 3.png")
    background_4 = pygame.image.load("static/8/png/ground/background 4.png")
    ...
    sad_end.image = pygame.image.load("static/8/png/ground/sad.png")
    happy_end.image = pygame.image.load("static/8/png/ground/happy.png")
    ...
    Inaction = pygame.image.load("static/8/png/unicorn/Inaction.png")
    A = pygame.image.load("static/8/png/unicorn/A.png")
    D = pygame.image.load("static/8/png/unicorn/D.png")
    Sa = pygame.image.load("static/8/png/unicorn/SA.png")
    Sd = pygame.image.load("static/8/png/unicorn/SD.png")
    Wa = pygame.image.load("static/8/png/unicorn/WA.png")
    Wd = pygame.image.load("static/8/png/unicorn/WD.png")
    ...
    meteor_1 = pygame.image.load("static/8/png/objects/meteor 1.png")
    meteor_2 = pygame.image.load("static/8/png/objects/meteor 2.png")
    meteor_3 = pygame.image.load("static/8/png/objects/meteor 3.png")
    meteor_4 = pygame.image.load("static/8/png/objects/meteor 4.png")
    ...
    meteorite_2.rect.centerx = WIDTH - 500
    ...
    meteorite_3.rect.centerx = WIDTH - 250
    meteorite_3.rect.centery = randint(
        meteorite_3.rect.width, HEIGHT - meteorite_3.rect.width
    )

    cake_1 = pygame.image.load("static/8/png/objects/cake 1.png")
    cake_2 = pygame.image.load("static/8/png/objects/cake 2.png")
    cake_3 = pygame.image.load("static/8/png/objects/cake 3.png")
    ...
    space = "static/8/music/Space.mp3"
    ...
    for line, titles_delay in zip(titles, range(250, 750, 20)):
        ...
        screen.blit(title_output, (250, titles_delay))
        clock.tick(2)
        pygame.display.update()
